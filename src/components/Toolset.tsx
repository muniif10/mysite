const Toolset = () => {
  const tools = [
    ...
    ["Spring", "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Spring_Framework_Logo_2018.svg/800px-Spring_Framework_Logo_2018.svg.png"],
    ["Oracle DBMS", "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Oracle_Logo.svg/1200px-Oracle_Logo.svg.png"],
      ...
      <div className="pt-3 flex flex-wrap flex-1 flex-row gap-5  place-content-center m-5">
        {tools.map((tool_used, index) => {
          return (
            ...
            >
              {tool_used[1] !== "" ?
                <img className="sm:h-[10vw] h-[10vh] m-auto object-contain sm:w-[7vw] w-[5em]" src={tool_used[1]} alt="" />
                :
