import about_achievemnts from "./about_achievement";
...
const About: React.FC = () => {
  ...
  const status_ongoing =
    " place-self-center font-bold text-sm mx-1 rounded-lg py-1 px-2 bg-gradient-to-br text-white from-amber-500 to-green-400";
  const status_finished =
    " place-self-center font-bold text-sm mx-1 rounded-lg py-1 px-2 bg-gradient-to-br text-white from-green-500 to-blue-400";
  return (
    <>
